  ...
  const categories: Category[] = [
    {
      ...
      items: [
        { name: 'Frisante Italiano Tinto Lambrusco Villa Giada Amabile 750ml', price: 'R$ 72,00' },
        { name: 'Santa Carolina Cabernet Sauvignon Merlot Vinho Tinto Chileno 750ml', price: 'R$ 60,00' },
        { name: 'Vinho Chileno Branco Reservado Chardonnay Santa Carolina 750ml', price: 'R$ 60,00' },
        ...
        { name: 'Vinho Reservado Cabernet Sauvignon Santa Carolina 750ml', price: 'R$ 60,00' },
        ...
        { name: 'Vinho Tinto Suave Reservado Santa Carolina 750ml', price: 'R$ 51,00' },
        { name: 'Vinho Sul-Africano Tinto 1791 Pinotage Nederburg 750ml', price: 'R$ 115,50' },
        { name: 'Vinho Chileno Branco Reservado Sauvignon Blanc Santa Carolina 750ml', price: 'R$ 60,00' },
      ]
    },
    {
      title: 'Refrigerantes',
      ...
      items: [
        { name: 'Coca-Cola Original 200ml', price: 'R$ 3,00' },
        { name: 'Drink Pronto Jack Daniel\'s com Coca-Cola 350ml', price: 'R$ 21,00' },
        { name: 'Fanta Laranja 2L', price: 'R$ 17,00' },
        { name: 'Fanta Uva 2L', price: 'R$ 18,50' },
        { name: 'Coca-Cola PET 2L', price: 'R$ 16,00' },
